...
def multinomial_probabilities(utilities: NDArray, check_infeasible=True) -> Tuple[NDArray, float, NDArray]:
...
def nested_probabilities(utilities: NDArray, hierarchy, levels, logsum_scales, bottom_flags, scale_utilities=True,
                         check_infeasible=True) -> Tuple[NDArray, float, NDArray]:
...
def multinomial_sample(utilities: NDArray, r: float) -> Tuple[int, float]:
    ...
    p_array, ls, _ = multinomial_probabilities(utilities, check_infeasible=True)  # Check infeasible req'd (for sampling)
...
def worker_multinomial_probabilities(utilities: NDArray, check_infeasible=True) -> Tuple[NDArray, NDArray, NDArray]:
...
def worker_nested_probabilities(utilities: NDArray, parents, levels, ls_scales, bottom_flags, scale_utilities=True,
                                check_infeasible=True) -> Tuple[NDArray, NDArray, NDArray]:
